...
namespace Cycle\ORM\PromiseMapper\Tests\Functional\Driver\Common\Inheritance\JTI;
...
abstract class SimpleCasesTest extends JtiBaseTest
{
    ...
    {
        $entity = (new Select($this->orm, static::EMPLOYEE_ROLE))->wherePK(static::EMPLOYEE_2_PK)->fetchOne();
    ...
    {
        $selector = (new Select($this->orm, static::EMPLOYEE_ROLE))->loadSubclasses(false);
    ...
    {
        $selector = (new Select($this->orm, static::ENGINEER_ROLE))->loadSubclasses(false);
    ...
    {
        $selector = (new Select($this->orm, static::ENGINEER_ROLE))->loadSubclasses(false)->limit(1);
